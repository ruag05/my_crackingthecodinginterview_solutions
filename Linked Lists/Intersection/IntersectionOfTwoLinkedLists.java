...
public class IntersectionOfTwoLinkedLists {
    ...
    //  linked list is the exact same node (by reference) as the jth node of the second linked list, they
    ...
    // Time complexity: O(N + M)
    // Space complexity: O(1)
    //took 1 ms (98 percentile) and 41.5 MB (94 percentile) (uses two pointers, to iterate their ll and once null is
    //encountered move to the start of other ll and goes on till they are both equal
