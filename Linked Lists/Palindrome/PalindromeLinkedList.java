...
public class PalindromeLinkedList {
    ...
    //converts the list to array and then uses two pointers, one from start and other from end, and compare whether
    ...
    // time complexity: O(n)
    // space complexity: O(n)
    //uses various pointers to, first calculate ll length, then find middle element, then reverse the second half of ll
    //and finally, compare the first half and second half
    public boolean isPalindrome2(ListNode head){
        ...
        //move to middle element (first middle element, if length is even)
        int counter = 0;
        ...
        while(startNode.next !=null) {
            ...
            nodeToSwap.next = midNode.next; //important line
